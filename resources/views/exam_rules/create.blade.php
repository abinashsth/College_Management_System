...
<div class="container mx-auto px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-semibold">Create Exam Rule</h1>
            <p class="text-gray-600 mt-1">Add a new rule for exams</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <form action="{{ route('exam-rules.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="col-span-2">
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#37a2bc] focus:ring focus:ring-[#37a2bc] focus:ring-opacity-50" required>
                    @error('title')
                ...
                <div class="space-y-2">
                    <div class="flex items-center">
                        <input type="checkbox" id="is_global" name="is_global" value="1" {{ old('is_global') ? 'checked' : '' }} class="rounded border-gray-300 text-[#37a2bc] focus:ring-[#37a2bc]">
                ...
                <div id="exam_selection">
                    ...
                    <select id="exam_id" name="exam_id" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#37a2bc] focus:ring focus:ring-[#37a2bc] focus:ring-opacity-50">
                        ...
                        <option value="{{ $examOption->id }}" {{ old('exam_id', $exam->id ?? '') == $examOption->id ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <input type="number" id="display_order" name="display_order" value="{{ old('display_order') }}" min="1" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#37a2bc] focus:ring focus:ring-[#37a2bc] focus:ring-opacity-50">
                    <p class="text-gray-500 text-xs mt-1">Leave blank for automatic ordering</p>
                    @error('display_order')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="space-y-2">
                    <div class="flex items-center">
                        <input type="checkbox" id="is_mandatory" name="is_mandatory" value="1" {{ old('is_mandatory') ? 'checked' : '' }} class="rounded border-gray-300 text-[#37a2bc] focus:ring-[#37a2bc]">
                ...
                <div class="space-y-2">
                    <div class="flex items-center">
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', '1') == '1' ? 'checked' : '' }} class="rounded border-gray-300 text-[#37a2bc] focus:ring-[#37a2bc]">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="description" name="description" rows="5" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#37a2bc] focus:ring focus:ring-[#37a2bc] focus:ring-opacity-50" required>{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="penalty_for_violation" name="penalty_for_violation" rows="3" class="w-full rounded-md border-gray-300 shadow-sm focus:border-[#37a2bc] focus:ring focus:ring-[#37a2bc] focus:ring-opacity-50">{{ old('penalty_for_violation') }}</textarea>
