            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('courses.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="course_code" id="course_code" class="form-input w-full @error('course_code') border-red-500 @enderror" value="{{ old('course_code') }}" required>
                        @error('course_code')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="course_name" id="course_name" class="form-input w-full @error('course_name') border-red-500 @enderror" value="{{ old('course_name') }}" required>
                        @error('course_name')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="duration" id="duration" class="form-input w-full @error('duration') border-red-500 @enderror" value="{{ old('duration') }}" required min="0.5" max="6" step="0.5">
                        @error('duration')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="description" id="description" class="form-textarea w-full @error('description') border-red-500 @enderror" rows="3">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                        @enderror
                    </div>
