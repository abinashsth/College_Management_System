...
<div class="container mx-auto px-4">
    <div class="flex flex-col md:flex-row items-center justify-between mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Edit Course: {{ $course->code }}</h1>
        <div class="mt-4 md:mt-0 flex space-x-2">
            <a href="{{ route('courses.show', $course) }}" class="px-4 py-2 bg-blue-600 text-white rounded shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition">
            ...
            <form method="POST" action="{{ route('courses.update', $course) }}">
                ...
                <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="credit_hours" id="credit_hours" value="{{ old('credit_hours', $course->credit_hours) }}" min="0" required
                    ...
                    <div>
                        ...
                        <input type="number" name="lecture_hours" id="lecture_hours" value="{{ old('lecture_hours', $course->lecture_hours) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="lab_hours" id="lab_hours" value="{{ old('lab_hours', $course->lab_hours) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="tutorial_hours" id="tutorial_hours" value="{{ old('tutorial_hours', $course->tutorial_hours) }}" min="0"
                    ...
                    <div>
                        ...
                        <select name="type" id="type"
                            ...
                            <option value="mandatory" {{ old('type', $course->type) == 'mandatory' ? 'selected' : '' }}>Mandatory</option>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" id="description" rows="3"
                              class="shadow-sm border-gray-300 rounded-md w-full py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('description', $course->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="learning_outcomes" id="learning_outcomes" rows="3"
                              class="shadow-sm border-gray-300 rounded-md w-full py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('learning_outcomes') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('learning_outcomes', $course->learning_outcomes) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="evaluation_criteria" id="evaluation_criteria" rows="3"
                              class="shadow-sm border-gray-300 rounded-md w-full py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('evaluation_criteria') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('evaluation_criteria', $course->evaluation_criteria) }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea name="syllabus" id="syllabus" rows="4"
                              class="shadow-sm border-gray-300 rounded-md w-full py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('syllabus') border-red-300 text-red-900 placeholder-red-300 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('syllabus', $course->syllabus) }}</textarea>
                    @error('syllabus')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
    ...
    <div class="mt-6 flex justify-between">
        <div>
            <a href="{{ route('courses.prerequisites', $course) }}" class="px-4 py-2 bg-indigo-600 text-white rounded shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition">
                <i class="fas fa-stream mr-1"></i> Manage Prerequisites
            </a>
            <a href="{{ route('courses.programs', $course) }}" class="ml-2 px-4 py-2 bg-green-600 text-white rounded shadow hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition">
                <i class="fas fa-project-diagram mr-1"></i> Manage Programs
            </a>
        </div>
        <form action="{{ route('courses.destroy', $course) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this course? This action cannot be undone.');">
            @csrf
            @method('DELETE')
            <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded shadow hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 transition">
