    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-semibold text-gray-700">Upcoming Assignments</h3>
                        <p class="text-3xl font-bold text-green-600">{{ $upcomingAssignments }}</p>
                    </div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <h3 class="text-lg font-semibold text-gray-700">Overdue Assignments</h3>
                        <p class="text-3xl font-bold text-red-600">{{ $overdueAssignments }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('assignments.index') }}" method="GET" class="space-y-4 sm:space-y-0 sm:flex sm:space-x-4">
                ...
                <div class="p-6 text-gray-900">
                    <div class="overflow-x-auto">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $assignment->subject->name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $assignment->class->name ?? 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 {{ $assignment->isOverdue() ? 'text-red-600 font-semibold' : '' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="{{ route('assignments.submissions', $assignment) }}" class="text-blue-600 hover:text-blue-900">Submissions</a>
                                            
                                            @can('edit assignments')
                                            <a href="{{ route('assignments.edit', $assignment) }}" class="text-green-600 hover:text-green-900">Edit</a>
                                            @endcan
                        ...
                        <div class="text-center py-8">
                            ...
                            @can('create assignments')
                            <a href="{{ route('assignments.create') }}" class="mt-2 inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
