...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Class: {{ $class->class_name }}</h1>
    ...
    <div class="bg-white rounded shadow-md max-w-3xl mx-auto p-6">
        <form action="{{ route('classes.update', $class->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $class->capacity) }}" required min="1"
                       class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-teal-500 focus:outline-none"
