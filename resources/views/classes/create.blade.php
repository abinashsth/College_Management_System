...
<div class="container mx-auto px-6 py-8">
    <div class="flex items-center justify-between">
        <h3 class="text-gray-700 text-3xl font-medium">Create New Class</h3>
            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <form action="{{ route('classes.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="class_name" id="class_name" class="form-input w-full @error('class_name') border-red-500 @enderror" value="{{ old('class_name') }}" required>
                        @error('class_name')
